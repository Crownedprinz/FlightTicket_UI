...
class CustomShapeClipper extends CustomClipper<Path>{
  ...
  getClip(Size size) {
    ...
    //This sets the end of the curve midway of the bottom line and takes the height 30inches upward
    var firstEndPoint = Offset(size.width * 0.5, size.height - 30.0);

    //This sets the the middle of the curve 50 inches upward
    // (o.25 is Screens divided into four parts and one part divided into two)
